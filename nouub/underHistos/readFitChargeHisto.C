...
void readFitChargeHisto()
{
  ...
  charge->GetXaxis()->SetTitle("[FADC]");
  charge->GetYaxis()->SetTitle("Counts [au]");
  charge->GetXaxis()->SetRangeUser(80, 250);
  histoStyle(charge);
  charge->Draw();
  ...
  c2->Print("../../plots/ubchargeHistoZoom863.pdf");
  ...
  chargeDer->GetYaxis()->SetRangeUser(-70,140);
  chargeDer->GetXaxis()->SetRangeUser(0,1000);
  ...
  leg->Draw();
  c3->Print("../../plots/ubchargeDerHisto863.pdf");
  ...
  chargeSmooDer->GetYaxis()->SetRangeUser(-70,140);
  chargeSmooDer->GetXaxis()->SetRangeUser(0,1000);
  ...
  leg->Draw();
  c4->Print("../../plots/ubchargeSmoothDerHisto863.pdf");
  ...
  c5->Print("../../plots/ubchargeFittedHisto863.pdf");
  ...
  */
  ...
  leg = new TLegend(0.14,0.17,0.52,0.38);
  ...
  c7->Print("../../plots/ubchargeFitResiduals863.pdf");
  ...
  c8->Print("../../plots/ubchargeFitPoly2863.pdf");
  ...
  c9->Print("../../plots/ubchargeFitResidualsPoly2863.pdf");
  ...
  c10->Print("../../plots/ubchargeFFTFitLogNorm863.pdf");
  ...
  c11->Print("../../plots/ubchargeFFTLogNormResiduals863.pdf");
  ...
  c12->Print("../../plots/ubchargeFFTFitPoly2863.pdf");
  ...
  c13->Print("../../plots/ubchargeFitFFTResidualsPoly2863.pdf");
  ...
  logNormResid->GetYaxis()->SetRangeUser(0, 50);
  ...
  c14->Print("../../plots/ubchargeResidualsDist863.pdf");
