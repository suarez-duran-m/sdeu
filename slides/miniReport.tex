...
\begin{frame}
  \begin{columns}
    \begin{column}{1.\textwidth}
      \includegraphics[width=1.\textwidth]{../plots/accuracyQpksFitsCdasPmt1.pdf}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  \begin{columns}
    \begin{column}{1.\textwidth}
      \includegraphics[width=1.\textwidth]{../plots/accuracyQpksFitsCdasPmt2.pdf}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  \begin{columns}
    \begin{column}{1.\textwidth}
      \includegraphics[width=1.\textwidth]{../plots/accuracyQpksFitsCdasPmt3.pdf}
    \end{column}
  \end{columns}
\end{frame}
