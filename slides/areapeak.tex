...
\begin{frame}
  ...
  \centering
	\includegraphics[width=.49\textwidth]{../plots/ubChHistFitSt1223.pdf}
	\includegraphics[width=.49\textwidth]{../plots/uubChHistFitSt1223.pdf}
...
\begin{frame}
  ...
  \centering
	\includegraphics[width=.49\textwidth]{../plots/uBapPMT1Hg.pdf}%\quad%
	\begin{minipage}[b][0.2\textheight][c]
		{.15\linewidth}
	\end{minipage}\\[1em]
	\includegraphics[width=.48\textwidth]{../plots/uBapPMT2Hg.pdf}\quad%
	\includegraphics[width=.48\textwidth]{../plots/uBapPMT3Hg.pdf}
\end{frame}
