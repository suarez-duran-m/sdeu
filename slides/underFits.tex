...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tabularx}{\textwidth}{CC}
      ...
      &
      \begin{tabular}{l}
        \includegraphics[width=.5\textwidth]{../plots/peakDerHisto863.pdf}
      \end{tabular}
      \\
      \footnotesize
      \begin{tabular}{l}
        The algorithm:
        1. Smooth Histogram \\
        2. Derivating of smooth Histogram \\
...
\begin{frame}
  \frametitle{UUB Peak: Comparison Fit and Residuals}
  \begin{figure}
    \centering
    \begin{tabularx}{\textwidth}{CC}
      \begin{tabular}{l}
        \includegraphics[width=.49\textwidth]{../plots/peakFitCompar863.pdf}
      \end{tabular}
      &
      \begin{tabular}{l}
        \includegraphics[width=.49\textwidth]{../plots/peakResidualsCompar863.pdf}
      \end{tabular}
      \\
      \begin{tabular}{l}
        \includegraphics[width=.49\textwidth]{../plots/peakResidualsDist863.pdf}
      \end{tabular}
    \end{tabularx}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tabularx}{\textwidth}{CC}
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubChisDistPmtsPk863.pdf}
      \end{tabular}
      &
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubProbDistPmtsPk863.pdf}
      \end{tabular}
    \end{tabularx}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tabularx}{\textwidth}{C}
      \begin{tabular}{l}
        \includegraphics[width=0.9\textwidth]{../plots/ubPeakFitAnomalousPmt2863.png}
      \end{tabular}
    \end{tabularx}
  \end{figure}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tabularx}{\textwidth}{CC}
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubChisDistPmtsCh863.pdf}
      \end{tabular}
      &
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubProbDistPmtsCh863.pdf}
      \end{tabular}
    \end{tabularx}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tabularx}{\textwidth}{CC}
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubPeakDistPmts863.pdf}
      \end{tabular}
      &
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubChargeDistPmts863.pdf}
      \end{tabular}
      \\
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubAoPSt863Pmts.pdf}
      \end{tabular}
    \end{tabularx}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tabularx}{\textwidth}{CC}
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubChisDistPmtsPk1740.pdf}
      \end{tabular}
      &
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubProbDistPmtsPk1740.pdf}
      \end{tabular}
    \end{tabularx}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tabularx}{\textwidth}{CC}
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubChisDistPmtsCh1740.pdf}
      \end{tabular}
      &
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubProbDistPmtsCh1740.pdf}
      \end{tabular}
    \end{tabularx}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tabularx}{\textwidth}{CC}
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubPeakFailHisto1740Pmt1.pdf}
      \end{tabular}
      &
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubPeakFailResiduals1740Pmt1.pdf}
      \end{tabular}
      \\
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubPeakSmoothFailResiduals1740Pmt1.pdf}
      \end{tabular}
    \end{tabularx}
  \end{figure}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tabularx}{\textwidth}{CC}
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubPeakDistPmts1740.pdf}
      \end{tabular}
      &
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubChargeDistPmts1740.pdf}
      \end{tabular}
      \\
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/ubAoPSt1740Pmts.pdf}
      \end{tabular}
    \end{tabularx}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tabularx}{\textwidth}{CC}
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/uububAoPtimePmt1St863.pdf}
      \end{tabular}
      &
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/uububAoPtimePmt2St863.pdf}
      \end{tabular}
      \\
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/uububAoPtimePmt3St863.pdf}
      \end{tabular}
    \end{tabularx}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tabularx}{\textwidth}{CC}
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/uububAoPtimePmt1St1740.pdf}
      \end{tabular}
      &
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/uububAoPtimePmt2St1740.pdf}
      \end{tabular}
      \\
      \begin{tabular}{l}
        \includegraphics[width=.48\textwidth]{../plots/uububAoPtimePmt3St1740.pdf}
      \end{tabular}
    \end{tabularx}
  \end{figure}
\end{frame}
