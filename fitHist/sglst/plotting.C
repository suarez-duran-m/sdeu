...
/*
  ...
  charge->GetYaxis()->SetTitleOffset(1.2);
  ...
  t->AddText("UUB Charge histogram No Offset "+pmtId);
  t->SetFillColor(0);
  t->SetFillStyle(0);
  t->SetLineColor(0);
  t->SetLineWidth(15);
  ...
  c1->cd();
  c1->SetSelected(c1);
  c1->Print("../../plots/uubChargeNoOffset"+pmtId+".pdf");
*/
...
/*
	...
	peak->GetXaxis()->SetTitle("Bin [FADC]");
  peak->GetXaxis()->SetTitleSize(0.045);
  peak->GetXaxis()->SetLabelSize(0.04);
	peak->GetYaxis()->SetTitle("Counts [au]");
  peak->GetYaxis()->SetTitleSize(0.045);
  peak->GetYaxis()->SetLabelSize(0.04);
	peak->GetYaxis()->SetTitleOffset(1.1);
	peak->Draw();
  legend = new TLegend(0.44,0.77,0.89,0.88);
  legend->AddEntry(peak,"#splitline{UUB Peak-Histogram PMT1, St863}{Event: 61219267 Corr. HBase: 283}","f");
...
/*
  ...
  peak->GetYaxis()->SetLabelSize(0.04);
	peak->Draw();
  legend = new TLegend(0.44,0.77,0.89,0.88);
  legend->AddEntry(peak,"#splitline{UUB Peak-Histogram PMT1, St863}{Event: 61219267 Corr. Calib: 233}","f");
  gStyle->SetLegendFont(22);
  gStyle->SetLegendTextSize(0.035);
  legend->Draw();
...
/*
	...
	peak->SetLineColor(kBlue);
	peak->GetXaxis()->SetTitle("Bin [FADC]");
	peak->GetXaxis()->SetRangeUser(40, 80);
  peak->GetXaxis()->SetTitleSize(0.045);
  peak->GetXaxis()->SetLabelSize(0.04);
	peak->GetYaxis()->SetTitle("Counts [au]");
	peak->GetYaxis()->SetTitleOffset(1.1);
