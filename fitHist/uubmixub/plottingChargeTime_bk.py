...
ax11.errorbar(chpmt1[0][1][stchoo], chpmt1[1][1][stchoo], yerr=chpmt1[2][1][stchoo], fmt=markers[1], markersize=mkrSize, color='tab:orange', label="UUB")
...
ax11.set_ylabel("Vem-Charge [FADC]", fontsize=12)
...
ax21.errorbar(chpmt2[0][1][stchoo], chpmt2[1][1][stchoo], yerr=chpmt2[2][1][stchoo], fmt=markers[1], markersize=mkrSize, color='tab:orange', label="UUB")
...
ax21.set_ylabel("Vem-Charge [FADC]", fontsize=12)
...
ax31.errorbar(chpmt3[0][1][stchoo], chpmt3[1][1][stchoo], yerr=chpmt3[2][1][stchoo], fmt=markers[1], markersize=mkrSize, color='tab:orange', label="UUB")
...
ax31.set_ylabel("Vem-Charge [FADC]", fontsize=12)
